                   ...
                   <?php foreach($results as $res):?>
                    <tr>                    
                      ...
                      ?>
                        ...
                        <td> <?php $date = $res['createddate'];
                        $date = strtotime($date);
                        $date = date('m/d/Y H:i:s A', $date);
                        echo $date;?></td>
                        <td> <?php $date = $res['duedate'];
                        $date = strtotime($date);
                   ...
                   <?php foreach($results as $res):?>
                    <tr>                    
                      ...
                      ?>
                        ...
                        <td> <span style='text-decoration:line-through; font-style: italic; color: #c1c1c1'><?php $date = $res['createddate'];
                        $date = strtotime($date);
                        $date = date('m/d/Y H:i:s A', $date);
                        echo $date;?></span></td>
                        <td> <span style='text-decoration:line-through; font-style: italic; color: #c1c1c1'><?php $date = $res['duedate'];
                        $date = strtotime($date);
                        $date = date('m/d/Y H:i:s A', $date);
                        echo $date;?></span></td>
                        <td>
